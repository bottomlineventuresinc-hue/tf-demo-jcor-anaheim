/* Template Factory - J Cor live demo journey.
...
(function () {
  ...
  var LIVE_URL = 'https://bottomlineventuresinc-hue.github.io/tf-demo-jcor-anaheim/';
  var LS_CHANGES = 'tf_jcor_change_log_v1';
  var LS_PURCHASED = 'tf_jcor_purchased_v1';
      ...
      apply: function () {
        if (heroLede) {
          heroLede.textContent =
            'Plumbing, electrical, kitchen and bath remodel, and general construction across Anaheim and Orange County. Fixed itemised quotes before we start, Jared as your named lead on site, and a twelve-month workmanship guarantee when we leave.';
        }
      }
    },
    {
      ...
      apply: function () {
        if (heroH) {
          heroH.innerHTML = 'Plumbing, electrical,<br>and remodels,<br>quoted <em>before</em> we start.';
        }
      }
    },
    {
      ...
      apply: function () {
        if (serviceFirst) {
          serviceFirst.textContent = 'Plumbing (written programme)';
        }
      }
    }
  ];
  ...
  function setBarMode(mode) {
    ...
    if (mode === 'updated') {
      ...
      barSub.textContent = 'Draft for Jared at J Cor. Claim it, preview the rest of the journey, or request a change.';
    }
  }
  ...
  if (changeForm) {
    changeForm.addEventListener('submit', function (e) {
      ...
      runSpinner(
        ...
        'Updating the draft for J Cor. Hang tight.',
        delay,
        function () {
