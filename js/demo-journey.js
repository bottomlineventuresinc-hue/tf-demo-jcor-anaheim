/* Template Factory - J Cor Plumbing Electrical General Contractor live demo journey.
...
(function () {
  ...
  var demoEdits = [
    ...
    },
    {
      ...
      apply: function () {
        if (heroH) {
          heroH.innerHTML = 'Plumbing and electrical,<br>priced <em>first.</em>';
        }
      }
    },
    {
      ...
      apply: function () {
        if (serviceFirst) {
          serviceFirst.textContent = 'Plumbing repairs and water heaters (written price)';
        }
      }
    }
  ];
  ...
  function setBarMode(mode) {
    ...
    if (!barSub) return;
    if (mode === 'updated') {
      barSub.textContent = 'Draft for Jared at J Cor Plumbing Electrical General Contractor. Claim it, preview the rest of the journey, or request a change.';
    } else {
      barSub.textContent = 'Draft for Jared at J Cor Plumbing Electrical General Contractor. Claim it, preview the rest of the journey, or request a change.';
    }
  }
  ...
  if (changeForm) {
    changeForm.addEventListener('submit', function (e) {
      ...
      runSpinner(
        ...
        'Updating the draft for J Cor Plumbing Electrical General Contractor. Hang tight.',
        delay,
        function () {
